...
<div class="row mb-5">
	<div class="col-md-6 col-lg-4 mb-4">
		<?foreach($arResult["ITEMS"] as $arItem):?>
			...
			?>
			<figure> <img alt="Image" src="<?= $arItem["PREVIEW_PICTURE"]["SRC"] ?>" class="img-fluid" href="<?= $arItem["DETAIL_URL"] ?>"> </figure>
			
			<div class="prop-text">
				<div class="inner">
				<span class="price rounded"></span>
				<small id="<?=$this->GetEditAreaId($arItem['ID']);?>"><span class="news-date-time"><?echo $arItem["DISPLAY_ACTIVE_FROM"]?>&nbsp;&nbsp;</span><a href="<?echo $arItem["DETAIL_PAGE_URL"]?>"><?echo $arItem["NAME"]?></a><br /></small>
					<div class="prop-more-info">
						<div class="inner d-flex">
							<div class="col">
								 Area: <strong><?echo $arResult['FIELD_CODE']['AREAL']['DISPLAY_VALUE']?><sup></sup></strong>
							</div>
							<div class="col">
